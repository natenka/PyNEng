### Добавление изменений в Git и на GitHub

В данной главе описано, как производить операции с репозиториями GitHub, такие как клонирование репозитория, его синхронизация, pull и push.
...
Для локальной работы с созданным репозиторием его нужно клонировать. Для этого используется команда git clone:
...
* были скачаны все данные репозитория;
* были скачаны все изменения, которые были произведены ранее в репозитории;
* репозиторий на GitHub был настроен как удалённый для локального репозитория.
...
* перед началом работы синхронизировать локальное содержимое с GitHub командой git pull (синхронизация с GitHub в локальный репозиторий);
...
При работе с заданиями на работе и дома, нужно обращать особое внимание на первый и последний шаг:
...
Если были изменения, то вывод будет примерно таким:
